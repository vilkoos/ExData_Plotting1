---
title: "Produce .png flies with plots to explore data."
...
A description of the project can be found in the [readme.md](README.md)
...
To get the English abbreviation for the weekdays, set the local LC_TIME variable to English.
